...
{
    public partial class Consulta_Ajuste_D : Form
    {
        public Consulta_Ajuste_D()
        {
            InitializeComponent();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string consulta = "SELECT * FROM ajuste_d WHERE InventarioNo= '" + txtFiltro.Text + "'";
        ...
        private void Consulta_Ajuste_D_Load(object sender, EventArgs e)
        {
            database.conexion con = new database.conexion();
            string consulta = "Select * from ajuste_d";
