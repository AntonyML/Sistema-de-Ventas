...
namespace sistema_de_ventas
{
    ...
    {
        public event Action<DataRow> ClienteSeleccionado;
        ...
        {
            conexion.Open();
            string consulta = "SELECT * FROM clientes WHERE ClienteNo = '" + txtfiltro.Text + "'";
            SqlDataAdapter adapt = new SqlDataAdapter(consulta, conexion);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                ClienteSeleccionado.Invoke(selectedRow);
                this.Close();
            }
        }
    }
