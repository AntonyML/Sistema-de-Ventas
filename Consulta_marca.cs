...
namespace sistema_de_ventas
{
    ...
    public partial class Consulta_marca : Form
    {
        ...
        private void Consulta_marca_Load(object sender, EventArgs e)
        {
        ...
        {
            conexion.Open();
            string consulta = "SELECT * FROM marca WHERE Marca = '" + txtFiltro.Text + "'";
            SqlDataAdapter adapt = new SqlDataAdapter(consulta, conexion);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
