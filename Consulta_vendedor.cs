...
namespace sistema_de_ventas
{
    public partial class Consulta_vendedor : Form
    {
        ...
        public event Action<DataRow> VendedorSeleccionado;
        ...
        {
            conexion.Open();
            string consulta = "SELECT * FROM vendedor WHERE vendedorNo = '" + txtFiltro.Text + "'";
            SqlDataAdapter adapt = new SqlDataAdapter(consulta, conexion);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                VendedorSeleccionado.Invoke(selectedRow);
                this.Close();
            }
        }
    }
